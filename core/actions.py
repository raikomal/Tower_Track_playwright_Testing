...
#             "Clicked successfully and UI responded as expected"
#         )
...
#             f"Entered value: {value} successfully"
#         )
#     except Exception as e:
...
#             f"Selected {value} and data updated accordingly"
#         )
#     except Exception as e:
...
# =========================================================
# ACTION WRAPPERS  ✅ (MINIMAL CHANGE)
# =========================================================
def step_click(locator, description):
    try:
        time.sleep(STEP_DELAY)
        ...
        record_step(
            ...
            f"Click on {description}",
            f"{description} should be clickable",
            f"Clicked on '{description}' successfully"
        )
